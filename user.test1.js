...
describe("User Account Management", () => {
	...
	test("New user registration", async () => {
		const res = await User.register("happy012user", "password","Beh User","123456","12-12-12","3d", "happy012@gmail.com", "active")
		console.log(res)
		expect(res).toBe(true)
	})

	test("Duplicate username", async () => {
		const res = await User.register("happy123", "pass123","Beh","123456","12-12-12","3d", "happy012@gmail.com", "active")
		console.log(res)
	...
	test("User login successfully", async () => {
		...
		expect(res.cust_name).toBe("Happy One")
	...
	test("User update Phone successfully", async () => {
		const res = await User.updatephone("happy123","012-123456")
		console.log(res)
		expect(res._id.toString()).toBe("627e55fed0cbda83a836b16a")
		expect(res.cust_id).toBe("happy123")
		expect(res.cust_password).toBe("$2b$10$.Tw/k3y00nNaSzYBE5Q5FeX0hrk1SBMY1BRVjLdOAtK6oG.R2Of06")
	...
	test("User update Phone unsuccessfully", async () => {
		const res = await User.updatephone("happy12","012-123456")
		expect(res).toBe(false)
	})
